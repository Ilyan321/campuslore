      ...
      <div className="max-w-[1600px] mx-auto flex items-center justify-between gap-2 sm:gap-3">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="lg:hidden flex items-center justify-center w-8 h-8 rounded border border-blueprint-border bg-blueprint-raised text-blueprint-brass hover:text-white transition active:scale-[0.98]"
        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          <button
            onClick={onNewChat}
            className="flex items-center gap-1 px-2.5 sm:px-3 py-1.5 rounded border border-blueprint-border hover:border-blueprint-borderLight hover:bg-blueprint-raised text-blueprint-secondary hover:text-blueprint-primary font-mono text-xs transition active:scale-[0.98]"
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded border border-blueprint-border hover:border-blueprint-borderLight hover:bg-blueprint-raised text-blueprint-secondary hover:text-blueprint-primary font-mono text-xs transition active:scale-[0.98]"
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 sm:px-3.5 py-1.5 rounded bg-blueprint-primary hover:bg-white text-blueprint-canvas font-semibold text-xs transition active:scale-[0.98] flex-shrink-0 shadow-sm"
          >
